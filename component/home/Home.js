  ...
  return (
    <div>
      <div className="form">
        ...
        {!chooseChoice ? <DropPhoto /> : <SellProduct navigate={navigate} />}
      </div>
    </div>
  );
}
...
function SellProduct({ navigate }) {
  return (
    <div>
      ...
      <p className="header1">Nice to meet you, undefine</p>
      <p className="haeder1 header2">impact made by company name</p>
